...
const AttachmentPreview = ({file}) => {
    return (
        <div className="w-full flex items-center gap-2 py-2 px-3 rounded-md bg-slate-800">
            <div>
                {isPDF(file.file) && <img src="/img/pdf.png" className="w-8" alt="" />}
            ...
            <div className="flex-1 text-gray-400 text-nowrap text-ellipsis overflow-hidden" title={file.file.name}>
